          ...
          <div className="row g-5">
            <div className="col-lg-6">
              <div>
                ...
                <button className="btn-style px-4">SEND</button>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="row">
                ...
                <div className="col-md-9">
                  <p>
                    ...
                    the heart of the city. You can easily reach us by metro or
                    by land transport.
                  </p>
                </div>
              </div>
              ...
              <div className="row">
                ...
                <div className="col-md-9">
                  <p>
                    <strong>Address:</strong> 15/20 Dhanmandi Dhaka, 1214.
                  </p>
                  <p>
                    <strong>Phone:</strong> +88 0172390890
                  </p>
